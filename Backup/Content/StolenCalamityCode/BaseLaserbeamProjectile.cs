...
namespace AotC.Content.StolenCalamityCode
{
  public abstract class BaseLaserbeamProjectile : ModProjectile
  {
    ...
    public virtual void CutTiles()
    {
      ...
      double num = (double) ((Vector2) ref vector2_3).Length() * (double) this.Projectile.scale;

      Utils.TileActionAttempt tileActionAttempt = BaseLaserbeamProjectile.\u003C\u003EO.\u003C1\u003E__CutTiles ?? (BaseLaserbeamProjectile.\u003C\u003EO.\u003C1\u003E__CutTiles = new Utils.TileActionAttempt((object) null, __methodptr(CutTiles)));
